    ...
    @foreach ($orderData as $index => $order)
        ...
        <div class="container">
            ...
            <div style="border-bottom: 1px solid #d1d5db; padding: 6px 8px; text-align: center;">
                ...
                <p style="margin: 2px 0; font-size: 9px; font-weight: 600;">Thank you for choosing SriMadhuCrackers
                    Crackers. Your order has been placed successfully. Kindly make the payment in mentioned Bank Accounts in
                    our</p>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #d1d5db;">
                <tr>
                    ...
                    <td style="padding: 8px; text-align: center; vertical-align: middle;">
                        <p style="margin: 0; font-weight: 700; font-size: 13px; color: #ff0000;">Order Number :
                            {{ $order['id'] }}</p>
                    </td>
                </tr>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #d1d5db;">
                <tr>
                    <td style="width: 55%; padding: 6px 8px; border-right: 1px solid #d1d5db;">
                        <p style="margin: 0; font-weight: 700; font-size: 12px; color: #ff0000;">Order Date:
            ...
            {{-- Order Summary --}}
            <div style="padding: 4px 0; text-align: center; font-weight: 700; font-size: 12px;">Order Estimation Summary
            </div>
        ...
        <div class="footer-note">
            <p style="margin: 0;">Please note that there may be delays pertaining to shipping batches. You will be informed
                before we ship your order.</p>
            <p style="margin: 2px 0 0;">Kindly await our confirmation on processing and shipping status. For further
                queries, kindly reach out to our customer care</p>
        </div>
    @endforeach
</body>
